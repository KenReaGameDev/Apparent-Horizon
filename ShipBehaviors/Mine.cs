...
public class Mine : AiBehavior {

	public Mine(Ship inShip)
	{
	...
	{
		if (PlayerID > -1)
			ship.photonView.RPC("MineRPC", PhotonPlayer.Find(PlayerID), null);
		else
			ship.photonView.RPC("MineRPC", PhotonTargets.Others, null);	
	}
